...
func TestQUICStringToSpec(t *testing.T) {
	...
	spec, err := cycletls.QUICStringToSpec(TestQUICFingerprint, TestUserAgent, false, "", nil)
	if err != nil {
...
func TestQUICStringToSpecWithForceHTTP1(t *testing.T) {
	...
	spec, err := cycletls.QUICStringToSpec(TestQUICFingerprint, TestUserAgent, true, "", nil)
	if err != nil {
...
func TestQUICStringToSpecEmptyFingerprint(t *testing.T) {
	...
	_, err := cycletls.QUICStringToSpec("", TestUserAgent, false, "", nil)
	if err == nil {
...
func TestQUICStringToSpecShortFingerprint(t *testing.T) {
	...
	_, err := cycletls.QUICStringToSpec("123", TestUserAgent, false, "", nil)
	if err == nil {
...
func TestQUICStringToSpecFirefoxUserAgent(t *testing.T) {
	...
	spec, err := cycletls.QUICStringToSpec(TestQUICFingerprint, firefoxUA, false, "", nil)
	if err != nil {
